...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Excellence_Geoip::geoip_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('geoip')->getId()) {
            return __("Edit Mapping: '%1'", $this->escapeHtml($this->_coreRegistry->registry('geoip')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('geoip/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
